...
contract RisqUNIPool is
    IERCLiquidityPool,
    Ownable,
    BEP20("Risq UNI LP Token", "writeUNI")
{
    using SafeMath for uint256;
...
/**
 * @author macemclain
 * @title Risq UNI (Uniswap Token on BSC) Bidirectional (Call and Put) Options
...
contract RisqUNIOptions is Ownable, IRisqOptions {
     ...
     * @param token The address of UNI BEP20 token contract
     */
    constructor(
        ...
        ethToUniSwapPath[0] = pancakeRouter.WETH();
        ...
        )
    {
        ...
        totalETH = pancakeRouter.getAmountsIn(total, ethToUniSwapPath)[0];
    }
    ...
    /**
     * @notice Swap BNB to UNI via Pancakeswap router

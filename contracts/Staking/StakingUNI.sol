...
contract RisqStakingUNI is RisqStaking, IRisqStakingBEP20 {
    using SafeBEP20 for IBEP20;
    using SafeMath for uint;

    IBEP20 public immutable UNI;

    constructor(BEP20 _token, BEP20 uni) public
        RisqStaking(_token, "RISQ UNI Staking lot", "rUNI") {
        UNI = uni;
    }

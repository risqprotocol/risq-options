...
// File: contracts/Staking/RisqStakingETH.sol
...
contract RisqStakingETH is RisqStaking, IRisqStakingBEP20 {
    using SafeBEP20 for IBEP20;
    using SafeMath for uint;

    IBEP20 public immutable ETH;

    constructor(BEP20 _token, BEP20 eth) public
        RisqStaking(_token, "RISQ ETH Staking lot", "rETH") {
        ETH = eth;
    }
    ...
    function sendProfit(uint amount) external override {
        ...
        if (_totalSupply > 0) {
            ...
            ETH.safeTransferFrom(msg.sender, FALLBACK_RECIPIENT, amount);
        }
    }

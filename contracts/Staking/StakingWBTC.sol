...
contract RisqStakingWBTC is RisqStaking, IRisqStakingBEP20 {
    using SafeBEP20 for IBEP20;
    using SafeMath for uint;

    IBEP20 public immutable WBTC;

    constructor(BEP20 _token, BEP20 wbtc) public
        RisqStaking(_token, "RISQ WBTC Staking lot", "rWBTC") {
        WBTC = wbtc;
    }

...
// File: contracts/Staking/RisqStakingCAKE.sol
...
contract RisqStakingCAKE is RisqStaking, IRisqStakingBEP20 {
    using SafeBEP20 for IBEP20;
    using SafeMath for uint;

    IBEP20 public immutable CAKE;

    constructor(BEP20 _token, BEP20 cake) public
        RisqStaking(_token, "RISQ CAKE Staking lot", "rCAKE") {
        CAKE = cake;
    }
    ...
    function sendProfit(uint amount) external override {
        ...
        if (_totalSupply > 0) {
            ...
            CAKE.safeTransferFrom(msg.sender, FALLBACK_RECIPIENT, amount);
        }
    }

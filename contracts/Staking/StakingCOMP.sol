...
// File: contracts/Staking/RisqStakingCOMP.sol
...
contract RisqStakingCOMP is RisqStaking, IRisqStakingBEP20 {
    using SafeBEP20 for IBEP20;
    using SafeMath for uint;

    IBEP20 public immutable COMP;

    constructor(BEP20 _token, BEP20 comp) public
        RisqStaking(_token, "RISQ COMP Staking lot", "rCOMP") {
        COMP = comp;
    }
    ...
    function sendProfit(uint amount) external override {
        ...
        if (_totalSupply > 0) {
            ...
            COMP.safeTransferFrom(msg.sender, FALLBACK_RECIPIENT, amount);
        }
    }

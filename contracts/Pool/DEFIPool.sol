...
/**
 * @author macemclain
 * @title Risq sDEFI Liquidity Pool
 * @notice Accumulates liquidity in sDEFI from LPs and distributes P&L in sDEFI
 */
contract RisqERCPool is
    IERCLiquidityPool,
    Ownable,
    ERC20("Risq sDEFI LP Token", "writeDEFI")
{
    ...
    /*
     * @nonce A provider supplies sDEFI to the pool and receives writeDEFI tokens
    ...
    /*
     * @nonce Provider burns writeDEFI and receives sDEFI from the pool
     * @param amount Amount of sDEFI to receive
    ...
    /*
     * @nonce Returns provider's share in sDEFI
     * @param account Provider's address
     * @return Provider's share in sDEFI
     */
    ...
    /*
     * @nonce Returns the amount of sDEFI available for withdrawals
    ...
    /*
     * @nonce Returns the sDEFI total balance provided to the pool

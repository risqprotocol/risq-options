 ...
 */
contract RisqWBTCPool is
    IERCLiquidityPool,
    Ownable,
    BEP20("Risq WBTC LP Token", "writeWBTC")
{
    using SafeMath for uint256;
...
contract RisqWBTCOptions is Ownable, IRisqOptions {
     ...
     * @param token The address of WBTC BEP20 token contract
     */
    constructor(
        ...
        ethToWbtcSwapPath[0] = pancakeRouter.WETH();
        ...
        )
    {
        ...
        totalETH = pancakeRouter.getAmountsIn(total, ethToWbtcSwapPath)[0];
    }
    ...
    /**
     * @notice Swap ETH to WBTC via Pancakeswap router

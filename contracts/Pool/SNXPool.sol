...
/**
 * @author macemclain
 * @title Risq SNX Liquidity Pool
 * @notice Accumulates liquidity in SNX from LPs and distributes P&L in SNX
 */
contract RisqERCPool is
    IERCLiquidityPool,
    Ownable,
    ERC20("Risq SNX LP Token", "writeSNX")
{
    ...
    /*
     * @nonce A provider supplies SNX to the pool and receives writeSNX tokens
    ...
    /*
     * @nonce Provider burns writeSNX and receives SNX from the pool
     * @param amount Amount of SNX to receive
    ...
    /*
     * @nonce Returns provider's share in SNX
     * @param account Provider's address
     * @return Provider's share in SNX
     */
    ...
    /*
     * @nonce Returns the amount of SNX available for withdrawals
    ...
    /*
     * @nonce Returns the SNX total balance provided to the pool

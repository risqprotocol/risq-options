...
contract RisqLINKPool is
    IERCLiquidityPool,
    Ownable,
    BEP20("Risq LINK LP Token", "writeLINK")
{
    using SafeMath for uint256;
...
/**
 * @author macemclain
 * @title Risq LINK (Binance-Peg ChainLink Token) Bidirectional (Call and Put) Options
...
contract RisqLINKOptions is Ownable, IRisqOptions {
     ...
     * @param token The address of LINK BEP20 token contract
     */
    constructor(
        ...
        ethToLinkSwapPath[0] = pancakeRouter.WETH();
        ...
        )
    {
        ...
        totalETH = pancakeRouter.getAmountsIn(total, ethToLinkSwapPath)[0];
    }
    ...
    /**
     * @notice Swap ETH to LINK via Pancakeswap router
